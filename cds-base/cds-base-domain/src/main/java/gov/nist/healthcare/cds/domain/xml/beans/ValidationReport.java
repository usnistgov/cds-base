 ...
 *       &lt;sequence>
 *         &lt;element name="ReportMetaData" type="{http://www.example.org/testCase/}ReportMetaDataType"/>
 *         &lt;element name="TestCaseMetaData" type="{http://www.example.org/testCase/}TestCaseMetaDataType"/>
 *         &lt;element name="TestCaseInformation" type="{http://www.example.org/testCase/}TestCaseInformationType"/>
 *         &lt;element name="ValidationResult" type="{http://www.example.org/testCase/}ValidationResultType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
