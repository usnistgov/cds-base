 ...
 * generated in the gov.nist.healthcare.cds.domain.xml package. 
...
public class ObjectFactory {
    ...
    private final static QName _TestCase_QNAME = new QName("http://www.example.org/testCase/", "TestCase");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: gov.nist.healthcare.cds.domain.xml
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.org/testCase/", name = "TestCase")
